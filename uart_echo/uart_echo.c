...
//*****************************************************************************
void
UARTSend(uint8_t value)
{
 //   uint32_t ui32Count = strlen(pui8Buffer);
    //
...
main(void)
{
    ...
    //
    ROM_UARTConfigSetExpClk(UART7_BASE, g_ui32SysClock, 105000,
